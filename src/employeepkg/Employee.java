...
public class Employee implements Serializable {
    ...
    public Employee(int employeeID, String Name, String Address, String ContactNumber, String Email, LocalDate DateOfBirth, LocalDate DateOfJoining, String Password) {
    ...
    public static Employee getInstance(int EmployeeID, String Password) {
        ObjectInputStream ois = null;
        Employee oc = null;
        try {
             Employee c;
